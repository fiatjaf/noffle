<script>
	...
	async function setMetadata(e) {
		...
		editMeta = {}
		if(picUrl)
			editMeta.picture = window.encodeURI(picUrl.trim())
		if(bio)
			editMeta.about = sanitizeString(bio)
		if(petname)
			editMeta.name = sanitizeString(petname)
	...
	<div class="block">
		<form>
			<div class="field">
			  ...
			  <div class="control">
			    <input class="input" type="text" placeholder="Picture URL" bind:value={picUrl} />
			  </div>
			</div>
			<div class="field">
			  <label class="label">Nickname</label>
			  <div class="control">
			    <input class="input" type="text" placeholder="Nickname" bind:value={petname} />
			  </div>
			</div>
			<div class="field">
			  <label class="label">Bio</label>
			  <div class="control">
			    <textarea class="textarea" placeholder="Something about you..." bind:value={bio} />
			  </div>
			</div>
		</form>		
	</div>
